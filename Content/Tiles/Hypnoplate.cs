...
namespace EstherMod.Content.Tiles
{
    public class Hypnoplate : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            //ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ItemType<HypnoplateItem>();
