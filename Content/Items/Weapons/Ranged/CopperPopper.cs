...
public class CopperPopper : BaseItem {
	...
	public override Vector2? HoldoutOffset() { // So you are not holding on the buttstock
		return new Vector2(2f, -2f);
	}

	public override void ModifyShootStats(Player player, ref Vector2 position, ref Vector2 velocity, ref int type, ref int damage, ref float knockback) { // Makes it appear out the barrel.
