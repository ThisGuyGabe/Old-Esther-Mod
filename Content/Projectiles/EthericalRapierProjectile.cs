...
namespace EstherMod.Content.Projectiles
{
    ...
    public class EthericalRapierProjectile : ModProjectile
    {
        ...
        {
            // DisplayName.SetDefault("Etherical Dagger");
        }

        public override void SetDefaults()
        {
            Projectile.Size = new Vector2(26); // This sets width and height to the same value (important when projectiles can rotate)
