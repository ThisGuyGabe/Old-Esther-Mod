...
namespace EstherMod.Backgrounds
{
	public class EstherModBackgroundStyle : ModSurfaceBackgroundStyle
	{
		...
		public override int ChooseMiddleTexture()
		{
			...
			switch (SurfaceFrame)
			{
				...
				case 3:
					return BackgroundTextureLoader.GetBackgroundSlot("EstherMod/Assets/Textures/Backgrounds/ExampleBiomeSurfaceMid3"); // You can use the full path version of GetBackgroundSlot too
				default:
					return -1;
			}
		}
