...
namespace EstherMod.Particles
{
	public class EmberParticle : Particle
	{
		...
		{
			Texture2D circle = ModContent.Request<Texture2D>("EstherMod/Assets/Textures/Circle").Value;
			Texture2D ember = ModContent.Request<Texture2D>("EstherMod/Particles/EmberParticle").Value;
			Texture2D glow = ModContent.Request<Texture2D>("EstherMod/Assets/Textures/SoftGlow").Value;
